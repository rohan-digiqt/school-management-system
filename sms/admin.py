...
admin.site.register(sms_model.Classroom_Student)
admin.site.register(sms_model.Cource)
admin.site.register(sms_model.Department)
admin.site.register(sms_model.Exam)
admin.site.register(sms_model.Exam_Result)
admin.site.register(sms_model.Exam_Type)
